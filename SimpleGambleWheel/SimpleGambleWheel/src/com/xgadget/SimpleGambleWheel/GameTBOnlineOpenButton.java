...
public class GameTBOnlineOpenButton extends BasicLayoutView 
{
	...
	public GameTBOnlineOpenButton(Context context) 
	{
		super(context);
	...
	public GameTBOnlineOpenButton(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		// TODO Auto-generated constructor stub
		Initialize();
	...
	public GameTBOnlineOpenButton(Context context, AttributeSet attrs, int defStyle) 
	{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		Bitmap bitmap = ResourceHelper.GetOnlineOnButtonBitmap();
		if(bitmap != null)
