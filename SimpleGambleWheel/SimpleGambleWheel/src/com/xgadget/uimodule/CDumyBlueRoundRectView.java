...
public class CDumyBlueRoundRectView extends View 
{
	...
	public CDumyBlueRoundRectView(Context context) 
	{
		super(context);
	...
	public CDumyBlueRoundRectView(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		// TODO Auto-generated constructor stub
		Initialize();
	...
	public CDumyBlueRoundRectView(Context context, AttributeSet attrs, int defStyle) 
	{
	...
	protected void drawDumyBackground(Canvas canvas)
	{
        ...
        canvas.drawRoundRect(m_RepaintRect, 10.0f, 10.0f, ResourceHelper.GetBlueTexturePaint());
